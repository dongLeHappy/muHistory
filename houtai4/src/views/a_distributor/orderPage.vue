...
<template>
    <div style="padding: 5px">
        ...
        <Modal v-model="editShow" title="订单详情" @on-ok="ok" @on-cancel="cancel" width="700" :mask-closable=false :closable=false>
    ...
    export default {
        data: function () {
            return {
                ...
                timeoutUrl: '/order/timeout', //查询超时未自动派单的订单
                ...
                cleanerColumns: [
                    ...
                    {
                        title: '状态', key: 'orderStatus', align: 'center', minWidth: 120
                        , render: (h, params) => {
                        ...
                        render: (h, params) => {
                            ...
                            arr.push(h('Button', {
                                props: {type: 'primary', size: 'small'}, on: {
                                    click: () => {
                                        this.moveTo(params.row.id)
                                    }
                                }
                            }, '查看'));
                            if (this.reFlag) {
                                arr.push(h('Button', {
                                    props: {type: 'success', size: 'small', disabled: dis},
                                    on: {
                                        click: () => {
                                            this.ressign(params.row.id)
                                        }
                                    }
                                }, '改派'));
                            } else {
                ...
                columns: [//字段
                    ...
                    {title: '服务地区', key: 'orderSn', width: 140, minWidth: 120, fixed: 'left', align: 'center'},
                    // {title: '客户手机号', key: 'memberMobile', minWidth:100, align: 'center'},
                    {title: '订单号', key: 'memberMobile', width: 140, align: 'center'},
                    {
                        title: '下单时间', key: 'createTime', minWidth: 160, width: 100, align: 'center'
                        , render: (h, params) => {
                            return h('div', new Date(params.row.createTime).formatDef());
                        }
                    },
                    {title: '保洁ID', key: 'appointmentTime', minWidth: 160, width: 100, align: 'center'},

                    {title: '所属渠道商', key: 'addr', minWidth: 50, width: 200, align: 'center'},
                    {title: '预约服务时间', key: 'cleanArea', minWidth: 100, width: 120, align: 'center'},
                    {
                        title: '保洁类型', key: 'cleanType', width: 120, align: 'center'//minWidth:100
                        , render: (h, params) => {
                    ...
                    {
                        title: '订单金额', key: 'cleanArea', minWidth: 100, width: 120, align: 'center',
                        render: (h, params) => {
                            //计算保洁员收入;
                            let platformBonus = params.row.platformBonus;
                    ...
                    {
                        title: '我的收入', key: 'cleanArea', minWidth: 100, width: 120, align: 'center',
                        render: (h, params) => {
                            //计算保洁员收入;
                            let platformBonus = params.row.platformBonus;
                            let percent = params.row.platformBonusPercent;
                    ...
                    {
                        title: '结算状态', key: 'status', minWidth: 100, width: 150, align: 'center'
                        , render: (h, params) => {
                            let self = this;
                    ...
                    {
                        title: '订单状态', key: 'status', minWidth: 100, width: 150, align: 'center'
                        , render: (h, params) => {
                            let self = this;
                            let obj = self.myList[params.index].status;
                            if (obj === 1) obj = h('div', {attrs: {style: 'color:blue'}}, '订单已创建');
                    ...
                    {
                        title: '保洁时长(小时)', key: 'cleanPeriod', minWidth: 100, width: 120, align: 'center'
                        , render: (h, params) => {
                    ...
                    {
                        title: '支付余额时间', key: 'createTime', minWidth: 160, width: 100, align: 'center'
                        , render: (h, params) => {
                            return h('div', new Date(params.row.createTime).formatDef());
                        }
                    },
